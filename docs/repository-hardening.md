...
| 7–8: asynchronous failure                    | Observe root and nested mount promises; clean failed preparation before notifying reentrant handlers; retain the applied render baseline and allow retry after failure.                                                                         | Root mount/retry, applied element/cursor recovery, reentrant transition fallback, and asynchronous cleanup tests                                |
